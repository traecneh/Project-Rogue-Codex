...
class SiteSmokeTests(unittest.TestCase):
    ...
    def test_node_runner_includes_build_planner_flow(self):
        ...
        self.assertIn(".home-entry-grid", runner)
        self.assertIn("assertHomeFreshness", runner)
        self.assertIn(".home-freshness-panel", runner)
        self.assertIn("data-freshness-content-hash", runner)
