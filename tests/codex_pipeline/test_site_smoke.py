...
class SiteSmokeTests(unittest.TestCase):
    ...
    def test_node_runner_includes_build_planner_flow(self):
        ...
        self.assertIn('[data-discord-cta]', runner)
        ...
        self.assertIn(".history-story", runner)
        ...
        self.assertIn(".experience-build-grid", runner)
        ...
        self.assertIn(".races-card-grid", runner)
        ...
        self.assertIn(".guild-action-grid", runner)
        self.assertIn("assertSystemsTooltip", runner)
