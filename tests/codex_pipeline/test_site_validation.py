...
class SiteValidationTests(unittest.TestCase):
    ...
    def test_nav_and_site_search_include_collectables_and_useables(self):
        ...
        for expected in [
            ...
            'title: "Useables"',
            'category: "Items"',
            "Collectable items, materials, consumables, values, and traits.",
            "Useable tools, scrolls, shards, and utility items.",
            '["collectables", "collectibles", "materials", "potions", "ores", "shards"]',
